...
<title>Consultants change password</title>
			...
			<div>
				<div>
					<div>
											...
											<li id="current"><a href="consultants_changepwd.php"><span>Change password</span></a></li>
...
<br/>
     ...
     <form name="consultants_changepwd" action="consultants_changepwd.php" method="post" onSubmit="return validate(this);">
...
$password=convert($newpassword,$key);
$currentpassword=convert($password1,$key);
//$confirmnewpassword = md5($_POST['confirmnewpassword']);


$select = "SELECT password FROM consultants_register WHERE username ='".$username."' and password = '".$currentpassword."'";
$passwordcheck=false;
$checkcurrentpassword=mysql_query($select);
if($checkcurrentpassword!=null)
while($row=mysql_fetch_array($checkcurrentpassword))
{
	$passwordcheck=true;
}
if($passwordcheck==true)
 { 
	$update=mysql_query("UPDATE consultants_register SET password='".$password."' where username='".$username."'");
