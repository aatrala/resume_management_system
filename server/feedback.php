...
function validate(feedback)
{
	...
	if(feedback.subject.value=="Select")
	{
	...
	if(feedback.description.value=="Select")
	{
...
<p style="text-align: justify;"><span style="font-family: verdana;">Complete the form below to send us your comments and feedback.</span></p>
<br/>
<font color="red">&nbsp;&nbsp;Required *</font>
<br/><br/>
<form name="feedback" enctype="multipart/form-data" action="feedback.php" method="post" onSubmit="return validate(this);">
                  ...
                  <table align="center">
                        ...
                        <tr><td></td><td><p style="text-align: justify;"><span style="font-family: verdana;">Enter the name<font color="red"> * </font></span></p></td><td><input type="text" name="name"></td><td><lable style="display:none; color:red;" name="lblname" id="lblname" >Enter the Username</label></td></tr>
						<tr><td></td></tr>
						<tr><td></td></tr>
                        <tr><td></td><td><p style="text-align: justify;"><span style="font-family: verdana;">Email ID<font color="red"> * </font></span></p></td><td><input type="text" name="mailid"></td><td><lable style="display:none; color:red;" name="lblmailid" id="lblmailid" >Enter the mailid</label></td></tr>
					    <tr><td></td></tr>
						<tr><td></td></tr>
                        
                       
					    <tr><td></td><td><p style="text-align: justify;"><span style="font-family: verdana;">Subject<font color="red"> * </font></span></p></td>
                         <td>
                               ...
                               </td><td><lable style="display:none; color:red;" name="lblsubject" id="lblsubject" >Select the subject</label></td>
					   <tr></tr>
					   <tr><td></td></tr>
						<tr><td></td></tr>
                       <tr><td></td><td><p style="text-align: justify;"><span style="font-family: verdana;">Description</span></p></td><td><textarea  name="description" rows="5" cols="20"></textarea></td><td><lable style="display:none; color:red;" name="lbldescription" id="lbldescription" >Enter the description</label></td></tr>
					   <tr></tr>
...
$local_body_string= " Name: ".$_POST['name']."\n Email: ".$_POST['mailid']." \n Message Subject: ".$_POST['subject']." \n Message Description: ".$_POST['description']."\n";
	...
	$mail->Send();
	echo  '<br/><strong style="color:red;"> Thank you for your valuable feefback.</strong><br/>';
	}
?>
