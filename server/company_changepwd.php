...
<br/>
         ...
         <form name="company_changepwd" action="company_changepwd.php" method="post" onSubmit="return validate(this);">
			...
			<tr><td></td></tr>
                        ...
                        <tr><td></td><td><p style="text-align: justify;"><span style="font-family: verdana;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your current password<font color="red"> * </font></span></p></td><td><input type="password" name="password"></td>
<td>
						...
						<tr><td></td></tr>
						<tr><td></td></tr>
                        <tr><td></td><td><p style="text-align: justify;"><span style="font-family: verdana;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Choose a new password<font color="red"> * </font></span></p></td><td><input type="password" name="newpassword"></td>
							<td>
						...
						<tr><td></td></tr>
						<tr><td></td><td><p style="text-align: justify;"><span style="font-family: verdana;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Re-enter new password<font color="red"> * </font></span></p></td><td><input type="password" name="confirmnewpassword"></td>
							<td>
...
$cpassword1 = $_POST['newpassword'];
//$confirmnewpassword = md5($_POST['confirmnewpassword']);
$cpassword=convert($cpassword1,$key);

$select = "SELECT companypassword FROM tblcompanyregistration WHERE companyusername ='".$username."'";

            
			  $update=mysql_query("UPDATE tblcompanyregistration SET companypassword='".$cpassword."' where companyusername='".$username."'");
