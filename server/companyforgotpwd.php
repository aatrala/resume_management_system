...
<br/>
<form name="forgotpwd" enctype="multipart/form-data" action="companyforgotpwd.php" method="post">
...
function convert($str,$ky=''){
	...
	$sql = "SELECT companyusername,companypassword FROM tblcompanyregistration WHERE companyusername ='".$username."'";
	...
	$mailid=$rows['companyusername'];
	$your_password=$rows['companypassword'];
