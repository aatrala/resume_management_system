...
<br/>
<form name="forgotpwd" enctype="multipart/form-data" action="consultantforgotpwd.php" method="post">
...
function convert($str,$ky=''){
	...
	$sql = "SELECT username,password FROM consultants_register WHERE username ='".$username."'";
